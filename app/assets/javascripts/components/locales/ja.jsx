const ja = {
  ...
  "compose_form.placeholder": "ちゃんと研究してる？",
  "compose_form.privacy_disclaimer": "あなたの非公開D進は返信先ユーザーが所属する {domains} に送信されます。{domainsCount, plural, one {このサーバー} other {これらのサーバー}}は信頼できますか？投稿のプライバシー保護はMastodonサーバー内でのみ有効です。 {domains} {domainsCount, plural, one {がMastodonインスタンス} other {がMastodonインスタンス}}でない場合、あなたの投稿がプライベートなものとして扱われず、ブーストされたり予期しないユーザーに見られる可能性があります。",
  "compose_form.publish": "D進",
  ...
  "empty_column.community": "研究室タイムラインはまだ使われていません。何か書いてみましょう！",
  ...
  "navigation_bar.community_timeline": "研究室タイムライン",
  ...
  "notification.favourite": "{name} さんがあなたのD進をお気に入りに登録しました",
  "notification.follow": "{name} さんにフォローされました",
  "notification.mention": "{name} さんがあなたに返信しました",
  "notification.reblog": "{name} さんがあなたのD進をブーストしました",
